...
class ToggleTodoItemCompletionUseCase @Inject constructor(private val repository: TodoRepository) {
    operator fun invoke(todoItem: TodoItem) = repository.toggleCompletion(todoItem)
}